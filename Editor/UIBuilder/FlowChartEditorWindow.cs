...
namespace FlowGraph.Node
{
    ...
    {
        private FlowChart self;

        protected override void OnEnable()
        {
            base.OnEnable();
            self = (FlowChart)target;
            self.GetComponents<MonoState>().ToList().ForEach(x =>
                x.hideFlags = self.hideNode ? HideFlags.HideInInspector : HideFlags.None
            );
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                FlowChartEditorWindow.userSeletionGo = self.gameObject;
    ...
    public class FlowChartEditorWindow : EditorWindow
    {
        ...
        {
            //GetWindow<FlowChartEditorWindow>()?.Close();
        ...
        public void CreateGUI()
        {
            ...
            var visualTree =
                AssetDatabase.LoadAssetAtPath<VisualTreeAsset>(
                    "Packages/com.zpgame.flowgraph/Editor/UIBuilder/FlowChart.uxml");
            ...
            var styleSheet =
                AssetDatabase.LoadAssetAtPath<StyleSheet>(
                    "Packages/com.zpgame.flowgraph/Editor/UIBuilder/FlowChart.uss");
